...
export default function ManageCLM() {
  ...
  // ================= FETCH (ONLY CLM) =================
  const fetchCLMs = async () => {
    try {
      setLoad(true);
      const res = await ApiServices.GetAllClm();
  ...
  function changeInactiveStatus(id) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        ApiServices.ChangeStatusClm(payload)
          .then((res) => {
            Swal.fire({
