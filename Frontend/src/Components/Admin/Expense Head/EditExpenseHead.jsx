...
export default function EditExpenseHead() {
    ...
    useEffect(() => {
        ...
        ApiServices.GetSingleExpenseHead(data)
            .then((res) => {
    ...
    function handleForm(e) {
        ...
        ApiServices.UpdateExpenseHead(data)
            .then((res) => {
    ...
    return (
        <>
            <main id="main" className="main">
                <PageTitle child="Edit Expense Head" />
                    ...
                    <div className="col-lg-6 mx-auto mt-3">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">Expense Head Details</h5>
                                {/* Vertical Form */}
