    ...
    export default function ManageZonalHead() {
    ...
    // ================= FETCH (ONLY ZONAL HEAD) =================
    const fetchZonalHeads = async () => {
        try {
        setLoad(true);
        const res = await ApiServices.GetAllZh();
    ...
    function changeInactiveStatus(id) {
        ...
        if (result.isConfirmed) {
            ...
            ApiServices.ChangeStatusZh(payload)
            .then((res) => {
                Swal.fire({
    ...
    return (
        ...
        <main className={`main ${modalOpen ? "blur-background" : ""}`} id="main">
            <PageTitle child="Manage Zonal Heads" />
